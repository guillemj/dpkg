...
AC_DEFUN([DPKG_CHECK_COMPILER_WARNINGS], [
  ...
  DPKG_CHECK_COMPILER_FLAG([-Wtrailing-whitespace=any])
  ...
  [C], [
    ...
    DPKG_CHECK_COMPILER_FLAG([-Wc23-c2y-compat])
    DPKG_CHECK_COMPILER_FLAG([-Wc23-compat])
    DPKG_CHECK_COMPILER_FLAG([-Wc23-extensions])
