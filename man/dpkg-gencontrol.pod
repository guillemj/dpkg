...
(it will remove any dependency which evaluates to true given the
...
Support for optional argument since dpkg 1.17.2.
...
The source package template control file,
giving version-independent information about the source package and
the binary packages it can produce.
