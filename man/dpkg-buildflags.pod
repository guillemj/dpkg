...
This setting (since dpkg 1.22.0) enables
...
This setting (since dpkg 1.22.0) enables 64-bit time_t support
...
This setting (since dpkg 1.19.0) is now an alias
...
This setting (since dpkg 1.22.3) adds
...
This setting (since dpkg 1.17.4) adds any warning
...
This setting (since dpkg 1.17.14) adds dummy canary
...
This setting (since dpkg 1.21.0) enables
...
This setting (since dpkg 1.18.0) adds
...
This setting (since dpkg 1.16.1) adds
...
This setting (since dpkg 1.16.1) adds B<-fstack-protector --param=ssp-buffer-size=4>
...
This setting (since dpkg 1.17.11) adds
...
This setting (since dpkg 1.22.0) adds
...
This setting (since dpkg 1.22.0) adds B<-fcf-protection>
...
This setting (since dpkg 1.17.14) adds
B<-Wdate-time>
to B<CPPFLAGS>.
...
This setting (since dpkg 1.19.1) adds
...
This setting (since dpkg 1.18.5) adds
...
(and optionally exports them) into variables (since dpkg 1.19.0).
