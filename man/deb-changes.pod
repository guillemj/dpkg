...
This field specifies a whitespace separated list of build profile names
...
If the section is omitted in the source package template control file,
it defaults to B<unknown>
(since dpkg 1.22.13).

If the priority is omitted in the source package template control file,
it defaults to B<optional>
(since dpkg 1.22.13).
