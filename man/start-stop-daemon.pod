...
Supported since version 1.16.1.

=item B<--pidof>

Check for the existence of specified processes,
print their PIDs,
...
Check for a process with the specified I<pid>.
The I<pid> must be a number greater than 0.

Supported since version 1.17.6.
...
Supported since version 1.17.7.
...
Supported since version 1.19.3.

=item B<--notify-timeout> I<timeout>

Set a timeout for the B<--notify-await> option.
...
Supported since version 1.16.5.
...
Supported since version 1.20.6.
...
Supported since version 1.15.0.
...
Supported since version 1.13.22.
...
Supported since version 1.17.19.
