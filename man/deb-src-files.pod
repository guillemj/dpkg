...
entry.
The only currently supported keyword is:

=over 4

=item * B<automatic>

With value B<yes>, to mark automatically generated files.

=back

=head1 NOTES

This file is not intended to be modified directly, use one of
