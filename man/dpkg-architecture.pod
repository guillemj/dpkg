...
The CPU part of B<DEB_BUILD_GNU_TYPE>.

=item B<DEB_BUILD_GNU_SYSTEM>

The System part of B<DEB_BUILD_GNU_TYPE>.
...
The CPU part of B<DEB_HOST_GNU_TYPE>.
...
The CPU part of B<DEB_TARGET_GNU_TYPE> (since dpkg 1.17.14).

=item B<DEB_TARGET_GNU_SYSTEM>

The System part of B<DEB_TARGET_GNU_TYPE> (since dpkg 1.17.14).
