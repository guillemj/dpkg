...
The change details may be any series of lines starting with
...
maintainer.
The format for the name and email address is described in L<deb-email(7)>.
...
or B</* */> style comments or RCS keywords should be ignored.
