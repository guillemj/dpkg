...
of a problem here.
The current implementation uses the highest priority of
...
in the I<.dsc> file to modify maintainer information.
This might change.

The I<path-prefix>, if given, is prepended to the directory field in the
generated source index.
You generally use this to make the directory
...
Scan I<file> to find supplementary overrides.
The file can be compressed (since dpkg 1.15.5).
See
...
Use I<file> as the source override file.
The file can be compressed (since dpkg 1.15.5).
...
file.
It contains only two whitespace separated fields,
the first is the source package name and the second is the section.
Blank lines and comment lines are ignored in the normal manner.
