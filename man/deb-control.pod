...
syntax as above (since dpkg 1.17.11).
...
This field used to specify a whitespace separated list of build profile names
(without exclamation marks)
that this binary packages was built with.
